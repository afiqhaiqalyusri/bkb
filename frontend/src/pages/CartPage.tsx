                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                      ...
                      <div style={{ alignSelf: 'center' }}>
                        <CustomCheckbox checked={isSelected} onChange={() => toggleSelectItem(key)} />
                      </div>
          ...
          <div style={{
            ...
            {!isMobile && (
              <button
                ...
                disabled={selectedItems.length === 0 || storeClosed}
                style={{
                  width: '100%',
                  background: storeClosed || selectedItems.length === 0
                    ? 'var(--border)'
                    : 'var(--primary)',
                  color: storeClosed || selectedItems.length === 0 ? 'var(--text-secondary)' : '#fff',
                  border: 'none',
                  ...
                  fontWeight: 600,
                  fontSize: '0.9rem',
                  cursor: storeClosed || selectedItems.length === 0 ? 'not-allowed' : 'pointer',
                ...
                onMouseEnter={e => {
                  if (!storeClosed && selectedItems.length > 0) {
              ...
              >
                Checkout Selected ({selectedItems.length}) <IcoArrowRight />
              </button>
            )}
          </div>
        </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <button
                  ...
                  disabled={selectedItems.length === 0 || storeClosed}
                  style={{
                    background: storeClosed || selectedItems.length === 0 ? 'var(--border)' : 'var(--primary)',
                    color: storeClosed || selectedItems.length === 0 ? 'var(--text-secondary)' : '#fff',
                    border: 'none',
                    borderRadius: 'var(--radius-md)',
                    padding: '10px 18px',
