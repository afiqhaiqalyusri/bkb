...
public class EmailService {
    ...
    public void sendOrderScheduledEmail(String toEmail, String name, String orderNumber, java.time.LocalDateTime scheduledTime, java.math.BigDecimal total) {
        ...
        String html = buildOrderScheduledEmailHtml(name, orderNumber, scheduledTime, total);
        sendHtmlEmail(toEmail, subject, html);
    }
    ...
    public void sendOrderEnteredQueueEmail(String toEmail, String name, String orderNumber) {
        ...
        String html = buildOrderEnteredQueueEmailHtml(name, orderNumber);
        sendHtmlEmail(toEmail, subject, html);
    }
    ...
    public void sendPaymentSuccessEmail(String toEmail, String name, String orderNumber, java.math.BigDecimal amount) {
        ...
        String html = buildPaymentSuccessEmailHtml(name, orderNumber, amount);
        sendHtmlEmail(toEmail, subject, html);
    }
    ...
    public void sendOrderReadyEmail(String toEmail, String name, String orderNumber) {
        ...
        String html = buildOrderReadyEmailHtml(name, orderNumber);
        sendHtmlEmail(toEmail, subject, html);
    }
                  ...
                  <div style="max-width: 520px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <div style="padding: 40px;">
                      ...
                      <div style="background: #f0f4ff; border: 2px dashed #4f6ef7; border-radius: 10px; padding: 24px; text-align: center; margin: 0 0 28px;">
                        ...
                        <p style="color: #888; font-size: 13px; margin: 12px 0 0;">One-time code · expires in 10 minutes</p>
                      </div>
    ...
    private String buildOrderScheduledEmailHtml(String name, String orderNumber, java.time.LocalDateTime scheduledTime, java.math.BigDecimal total) {
        String firstName = name != null ? name.split(" ")[0] : "there";
    ...
    private String buildOrderEnteredQueueEmailHtml(String name, String orderNumber) {
        String firstName = name != null ? name.split(" ")[0] : "there";
        return """
                <!DOCTYPE html>
                <html>
    ...
    private String buildOrderReadyEmailHtml(String name, String orderNumber) {
        String firstName = name != null ? name.split(" ")[0] : "there";
        return """
                <!DOCTYPE html>
                <html>
    ...
    private String buildPaymentSuccessEmailHtml(String name, String orderNumber, java.math.BigDecimal amount) {
        String firstName = name != null ? name.split(" ")[0] : "there";
        return """
                <!DOCTYPE html>
                <html>
